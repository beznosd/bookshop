<div class="col-lg-3">
	<div class="list-group">
		...
		<a href="http://localhost/bookshop/?r=site/profile&menu_point=new_orders" class="list-group-item  active">
...
<div class="col-lg-9 order_info_block">
	...
	<?php for ($i = 0; $i < $c_orders; $i++): ?>
		<div id="a_profile_new_order_bloc_<?=$orders_info[$i]['id_order']?>">
			<p>
			...
			<a href="http://localhost/bookshop/?r=site/profile&menu_point=new_orders&action=submit_order&id_order=<?=$orders_info[$i]['id_order']?>" class="btn btn-success ajax_link">Подтвердить</a>
			<a href="http://localhost/bookshop/?r=site/profile&menu_point=new_orders&action=delete_order&id_order=<?=$orders_info[$i]['id_order']?>" class="btn btn-danger ajax_link">Удалить</a>
			<hr/>
		</div>
	<?php endfor; ?>
	<?php if($c_orders == 0): ?>
