...
<div class="col-lg-9">
	<form method="POST" action="">
		<div class="form-group">
			...
			<input type="password" class="form-control" id="old_pass" placeholder="Введите старый пароль">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="password" class="form-control" id="new_pass2" placeholder="Введите еше раз новый пароль">
		</div>
